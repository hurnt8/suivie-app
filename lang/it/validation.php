...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore fornito per :attribute è comparso in una violazione di dati. Scegli un :attribute diverso.',
    ],
    ...
    'attributes' => [
        ...
        'service_type' => 'servizio di consegna',
        'origin' => 'origine',
        'destination' => 'destinazione',
        'estimated_delivery_date' => 'data di consegna stimata',
        'special_instructions' => 'istruzioni particolari',
        'status' => 'stato',
        'title' => 'titolo',
        'location' => 'luogo',
        ...
        'tracking_prefix' => 'prefisso di tracciamento',
        'currency' => 'valuta',
        ...
        'mail_from_address' => 'indirizzo di invio delle e-mail',
        'mail_from_name' => 'nome visualizzato nelle e-mail',
        'logo' => 'logo',
        'sender.name' => 'nome del mittente',
        'sender.email' => 'e-mail del mittente',
        'sender.address' => 'indirizzo del mittente',
        'sender.city' => 'città del mittente',
        'sender.postal_code' => 'CAP del mittente',
        'sender.country' => 'paese del mittente',
        'recipient.name' => 'nome del destinatario',
        'recipient.email' => 'e-mail del destinatario',
        'recipient.address' => 'indirizzo del destinatario',
        'recipient.city' => 'città del destinatario',
        'recipient.postal_code' => 'CAP del destinatario',
        'recipient.country' => 'paese del destinatario',
    ],
